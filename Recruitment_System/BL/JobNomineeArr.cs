    ...
    class JobNomineeArr : ArrayList
    {
        public void Fill()
        {
            ...
            for (int i = 0; i < dataTable.Rows.Count; i++)
            {
                ...
                nominee = new JobNominee(dataRow);
        ...
        public bool Insert()
        {
            ...
            JobNominee jobNominee;
            for (int i = 0; i < this.Count; i++)
            {
                jobNominee = (this[i] as JobNominee);
                if (!jobNominee.Insert())
                    return false;
        ...
        //public JobNomineeArr Filter(JobNominee filter)
        //{
        //    JobNomineeArr nomineeArr = new JobNomineeArr();
